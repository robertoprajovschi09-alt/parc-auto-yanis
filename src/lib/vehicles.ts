...
export const vehicles: Vehicle[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "Sună-ne pentru detalii și o vizionare.",
    ],
  },
  {
    slug: "kia-ceed-2008",
  ...
  },
  {
    ...
    description: [
      ...
      "Restul detaliilor (an, kilometraj, motorizare) vin în curând. Sună-ne și îți spunem pe loc tot ce vrei să știi.",
    ],
  },
  {
  ...
  },
  {
    ...
    photos: gallery("dacia-logan", 10, "Dacia Logan 2017"),
    description: [
      "Dacia Logan albă din 2017, motor 1.0 benzină cu instalație de GPL — costuri de drum foarte mici.",
      "Mașina simplă și de încredere: întreținere ieftină și piese oriunde. Sună-ne pentru detalii.",
    ],
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      "Ideală pentru curierat sau transport de marfă. Recent adusă din Germania. Sună-ne pentru detalii.",
    ],
  },
  {
    ...
    description: ["Audi A4 Avant din 2010, motor 2.0 diesel de 143 CP, caroserie break."],
  },
  {
    slug: "bmw-320d-2010",
    brand: "BMW",
    ...
    description: ["BMW Seria 3 320d din 2010, motor 2.0 diesel. Preț negociabil."],
  },
  {
  ...
  },
  {
    ...
    photos: gallery("vw-golf-6", 15, "Volkswagen Golf 6, alb"),
    description: [
      "Volkswagen Golf 6 alb. Restul detaliilor (an, kilometraj, motorizare) vin în curând — sună-ne pentru informații.",
    ],
  },
];
